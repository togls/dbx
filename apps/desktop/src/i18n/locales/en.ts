export default {
  ...
  settings: {
    ...
    windowAppearance: {
      ...
      transparentBackground: "Mica window background",
      transparentBackgroundDescription: "Use the Windows 11 Mica material for the application shell.",
      backgroundOpacity: "Background opacity",
      backgroundOpacityDescription: "Higher values make the application background more opaque.",
      micaVisibilityHint: "Mica is requested from Windows. Visual changes depend on Windows transparency settings and window composition.",
      windows11Only: "Mica window backgrounds are currently available only in the Windows 11 desktop client.",
      applyFailed: "Mica could not be enabled in the current environment. DBX is using an opaque background.",
    },
