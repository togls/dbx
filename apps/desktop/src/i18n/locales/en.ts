export default {
  ...
  settings: {
    ...
    windowAppearance: {
      ...
      transparentBackgroundDescription: "Use the Windows 11 Mica window material.",
      backgroundOpacity: "Background opacity",
      backgroundOpacityDescription: "Higher values make the application background more opaque.",
      windows11Only: "Transparent backgrounds are currently available only in the Windows 11 desktop client.",
