...
export default withEnglishFallback({
  ...
  settings: {
    ...
    windowAppearance: {
      title: "窗口外观",
      transparentBackground: "Mica 窗口背景",
      transparentBackgroundDescription: "在应用壳层使用 Windows 11 Mica 材质。",
      backgroundOpacity: "背景浓度",
      backgroundOpacityDescription: "数值越高，应用背景越不透明。",
      micaVisibilityHint: "已请求 Windows 应用 Mica；实际视觉变化取决于系统透明效果设置和窗口合成状态。",
      windows11Only: "Mica 窗口背景目前仅支持 Windows 11 桌面客户端。",
      applyFailed: "当前环境无法启用 Mica，已自动使用不透明背景。",
    },
    navigationTab: "导航",
    dataTab: "数据",
    tunnelsTab: "隧道维护",
